...
### Self Check
- Do the odd numbered `p` elements share a class? ofcourse yes
- Do the even numbered `div` elements have unique IDs? ofcourse because you cant have 1 id for multiple elemet in one page 😎
- Does the Number 3 element have multiple classes? yes it is seperated by spaces ( )
