...
- Does each element have a unique class name? yes it was touchpwesae and mynonozone
- Did you use the grouping selector for styles that both elements share? ofcourse yes too
