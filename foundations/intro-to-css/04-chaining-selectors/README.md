...
### Self Check
- Did you properly chain class selectors for each rule? yes of course i do
- Does the `proportioned` image retain its original square proportions? yes it is
- Does the `distorted` image end up looking squished and, well, distorted? uhh...yes
